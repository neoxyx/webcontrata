...
<body>
    <?php      
      $query = $this->db->get_where('loterias',array('loteria'=>$sale['lottery']))->row();
      ...
      $logoLottery = 'data:image/' . $typelogoLottery . ';base64,' .
        ...
        //
        $urlBarCode = base_url().'Barcode/index?code='.$sale->barcode;
    ...
    <table style="text-align: center; margin-left: 15px; margin-right: 15px;">
        <tr>
          <td style="font-family: Helvetica">Loteria: <?= $sale['lottery']?> &nbsp;&nbsp;</td>
          <td style="font-family: Helvetica">|&nbsp;&nbsp; <?= $sale['lotteryname']?></td>
    ...
    <h1 style="font-family: Helvetica">$<?= number_format($sale['jackpot'], 0, ',', '.')?></h1>
    <p style="font-family: Helvetica"><?= date("Y-m-d H:i:s",strtotime($sale['datesale']))?></p>
    ...
    <table style="text-align: center;">
        <tr>
          <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
          <th style="font-family: Helvetica">Sorteo: <?= $sale['draw']?></th>
          <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
          <th style="font-family: Helvetica"><h5><?= date("d-m-Y",strtotime($sale['dateplay']))?></h5></th>
        </tr>
      </table>
      <table style="text-align: center;">
        <thead>
        ...
        <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td><b style="font-family: Helvetica"><?= $sale['number']?></b></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td><b style="font-family: Helvetica"><?= $sale['serie']?></b></td>
                </tr>
        </tbody>
      </table>
    <p style="font-family: Helvetica"><?= $sale['letters']?></p><br>
    <p style="text-align: left; font-family: Helvetica; margin-left: 15px;">Cantidad de fracciones: <?= $sale['fractions'] ?></p>
    <p style="text-align: left; font-family: Helvetica; margin-left: 15px;">Valor de la fraccion: $<?= number_format($sale['vrfraction'], 0, ',', '.')?></p>
    <p style="text-align: left; font-family: Helvetica; margin-left: 15px;">Fraccion: <?= $sale['fractions']. ' de ' .$sale['fractionsticket']; ?></p>
    <h3 style="text-align: left; font-family: Helvetica; margin-left: 15px;">Total: $<?= number_format($sale['total'], 0, ',', '.')?></h3>
