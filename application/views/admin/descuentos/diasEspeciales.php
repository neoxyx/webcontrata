      ...
      <div class="row">
        ...
        <div class="col-md-3" style="border: 1px solid #A8A8A8;">
            ...
            <form id="frmDcto">
                ...
                <input type="hidden" name="idtipo_dcto" id="idtipo_dcto" value="1">
                ...
                <div class="row">
                    <div class="col-lg-7">                        
                        <div class="form-group">
                        <label for="idtipo_comprador">Tipo de comprador</label>
                        <select name="idtipo_comprador" id="idtipo_comprador" class="form-control" required>
                            <option>Seleccione</option>                            
                        </select>
                        </div>
                        <!-- /form-group -->
                    ...
                    <div class="col-lg-5">
                        <div class="form-group">
                            <a href="#" data-toggle="modal" data-target="#modalTipoC">Crear tipo de comprador</a>
                        </div>
                        <!-- /form-group -->
                    </div> 
                </div>
                ...
                <div class="form-group">
                    <label for="compromiso">Loterias</label>
...
<div class="modal fade" id="modalTipoC" tabindex="-1" role="dialog" aria-labelledby="modalTipoCLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalTipoCLabel">Crear Tipo de comprador</h5>
        ...
        <form id="frmTipoc">                        
            <div class="modal-body">                
                <div class="form-group">
                    <label for="DESCR">Tipo de comprador</label>
                    <input type="text" class="form-control" name="DESCR" id="DESCR" placeholder="Descripción tipo de comprador" required>                
                </div>        
            </div>
