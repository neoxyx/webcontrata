<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="https://www.lottired.com">Lottired</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- jQuery multiselect -->
<script src="<?= base_url()?>plugins/jquery/dist/jquery.multiselect.js"></script>
...
<!-- Funciones -->
<script src="<?= base_url()?>dist/base_url.js"></script>
<script src="<?= base_url()?>dist/admin/js/dropzone.js"></script>
<!-- Needed html code here -->
<?php if (is_array($js_to_load)) { ?>
<?php foreach ($js_to_load as $row){ ?>
    <script type="text/javascript" src="<?= base_url()?>dist/admin/js/pages/<?=$row;?>"></script>
<?php } } ?>
